...
BeetlSQL 的目标是提供开发高效，维护高效，运行高效的数据库访问框架。从语法解析到数据映射，关系映射，到插件等的核心技术都是自研。目前支持的数据库如下
...
MyPerf4J 支持方法级的性能检测，支持 RPC 性能检测、拥有极致的性能。

## 测试

[ZenData](https://github.com/easysoft/zendata)
